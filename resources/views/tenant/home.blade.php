                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            <div class="card-header card-header-warning card-header-icon">
                                ...
                                <h4 class="card-title">@include('tenant.messenger.unread-count') Unread
                                </h4>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">copy</i>
                                    <a href="{{ route('tenant.messages') }}">See All</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            <div class="card-header card-header-danger card-header-icon">
                                ...
                                <h4 class="card-title">{{ $count_unread_notices }} Unread</h4>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">copy</i>
                                    <a href="{{ route('tenant.notice.index') }}">See All</a>
                                </div>
                            </div>
                        </div>
                    </div>
